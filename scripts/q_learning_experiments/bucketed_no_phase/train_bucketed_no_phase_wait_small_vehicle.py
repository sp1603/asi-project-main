...
EXPERIMENT_NAME = "q_learning_bucketed_no_phase_wait_small_vehicle"
...
def discretize_state(obs: np.ndarray) -> tuple[int, int, int, int]:
    ...
    return tuple(bucket_queue_length(float(x)) for x in directional_totals)
...
def main() -> None:
    ...
    for dataset_dir in dataset_dirs:
        ...
        print("\n" + "=" * 60)
        print("Training Q-learning with bucketed queues, no phase, wait+vehicle reward...")
