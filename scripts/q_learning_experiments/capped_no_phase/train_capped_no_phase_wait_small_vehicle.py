...
EXPERIMENT_NAME = "q_learning_capped_no_phase_wait_small_vehicle"
    ...
    for episode in range(episodes):
        ...
        while not done:
            ...
            if done:
                ...
                td_target = reward + float(gamma * np.max(q_table[next_state]))
...
def main() -> None:
    ...
    for dataset_dir in dataset_dirs:
        ...
        print("\n" + "=" * 60)
        print("Training Q-learning with capped counts, no phase, wait+small-vehicle reward...")
